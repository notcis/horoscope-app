      ...
      >
        ...
        <Tooltip
          ...
          formatter={(value, name) => {
            if (name === "wfh") {
              return [value, "Work form home"];
            } else {
              return [value, "Work form office"];
            }
          }}
        ...
        <Legend
          ...
          formatter={(value) => {
            if (value === "wfh") {
              return <div className="text-sm">Work form home</div>;
            } else {
              return <div className="text-sm">Work form office</div>;
            }
          }}
        />
